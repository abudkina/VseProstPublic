...
import (
	"net/http"
	temporaryLinkProblem "vseProst/models/TemporaryLinkProblem"
...
func CountTemporaryLinkProblem(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		var req temporaryLinkProblem.TemporaryLinkProblem
